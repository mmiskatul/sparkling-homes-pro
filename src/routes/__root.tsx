...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Fresh Spaces Cleaning | Residential Cleaning Services" },
      {
        name: "description",
        content:
          "Professional residential cleaning services for busy households. Reliable cleaners, flexible scheduling, free quotes.",
      },
      { property: "og:site_name", content: "Fresh Spaces Cleaning" },
